...
class CourseApi {
    static getAllCourses(): Observable<any> {
        return of(Object.assign([], courses)).pipe(debounceTime(15000));
    }
    ...
    static saveCourse(course): Observable<any>  {
        return of(() => {
            ...
            if (course.title.length < minCourseTitleLength) {
                throwError(`Title must be at least ${minCourseTitleLength} characters.`);
            }
